...
class CatalogServiceApplicationTests {
  ...
  private static KeycloakToken authenticateWith(String username, String password,
      WebClient webClient) {
    return webClient
        .post()
  ...
  void whenPutRequestThenBookUpdated() {
    ...
    var bookToUpdate = new Book(createdBook.id(), createdBook.isbn(), createdBook.title(),
        ...
        createdBook.version(), createdBook.createdBy(), createdBook.lastModifiedBy());
  ...
  void whenDeleteRequestThenBookDeleted() {
    ...
    webTestClient
        ...
        .expectBody(String.class).value(errorMessage ->
            assertThat(errorMessage).isEqualTo("A book with ISBN " + bookIsbn + " was not found.")
        );
  }
